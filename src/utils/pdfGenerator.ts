        ...
        ${module.chapters.map((chapter, chapterIndex) => `
          <div style="background: ${chapter.isImportant ? '#fef3c7' : '#f3f4f6'}; 
            ...
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 15px;">
              ...
              ${chapter.isImportant ? '<span style="background: #f59e0b; color: white; padding: 4px 12px; border-radius: 12px; font-size: 11px; font-weight: bold;">⭐ IMPORTANT</span>' : ''}
            </div>
            
            ${chapter.definition ? `
              <div style="background: white; padding: 15px; border-radius: 6px; margin: 15px 0; border-left: 3px solid #8b5cf6;">
                <strong style="color: #8b5cf6; font-size: 15px;">📖 Definition:</strong>
            ...
            <div style="background: white; padding: 15px; border-radius: 6px; margin: 15px 0;">
              <strong style="color: #4b5563; font-size: 15px;">📝 Overview:</strong>
