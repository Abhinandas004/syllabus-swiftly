      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Transform your syllabus into smart, summarized study notes in seconds with AI-powered technology.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                ...
                <a href="mailto:support@syllabustonotes.com" className="hover:text-primary transition-colors">
                  support@syllabustonotes.com
                </a>
              </div>
              <p className="text-sm text-muted-foreground">
        ...
        <div className="mt-8 pt-8 border-t border-border">
          <p className="text-center text-sm text-muted-foreground">
            © {new Date().getFullYear()} SyllabusToNotes. All rights reserved. | Powered by AI
          </p>
        </div>
      </div>
    </footer>
